//
//  PlacesCardCollectionView.swift
//  PolezniyEcoTourismApp
//
//  Created by Aleksandr Chebotarev on 11/3/22.
//

import UIKit

class PlacesCardCollectionView: UICollectionView {
    ...
    private func configure() {
        ...
        delegate = self
        dataSource = self
        register(PlacesCardCollectionViewCell.self, forCellWithReuseIdentifier: "cell")
    }
    
}

extension PlacesCardCollectionView: UICollectionViewDelegate {
    
}

extension PlacesCardCollectionView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.cardLocationName.text = "Locality"
...
extension PlacesCardCollectionView: UICollectionViewDelegateFlowLayout {
